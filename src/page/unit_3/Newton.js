    ...
    render() {
        ...
        return (
            <Container style={{ background: '#ffffff' }}>
                <body>
                    <h1><b><u>Newton's Divided Differences</u></b></h1>
                    <br />
                    <div>
                        <div className="col">
                            {this.state.showInputForm &&
                                <form style={{ textAlign: 'center', fontSize: '21px' }} id="inputCard">
                                    ...
                                    <InputGroup className="mb-3">
                                        <InputGroup.Prepend>
                                            <InputGroup.Text id="basic-addon1">interpolatePoint</InputGroup.Text>
                                        </InputGroup.Prepend>
                                        <FormControl
                                            placeholder="Input your interpolatePoint"
                                    ...
                                    <Button id="dimention_button"
                                        ...
                                        onClick={() => { this.createTableInput(parseInt(this.state.nPoints)); 
